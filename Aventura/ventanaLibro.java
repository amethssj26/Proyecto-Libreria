...
public class ventanaLibro {
    ...
    // Constructor
    public ventanaLibro(aventura libro) {
        ventana = new JFrame("Detalles del Libro");
        ventana.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ventana.setSize(1540, 1000);

        // Establecer el color de fondo de la ventana
        Color colorFondo = new Color(15, 19, 19, 255); // Azul oscuro
        ...
        tabbedPane.setForeground(new Color(15, 19, 19, 255)); // Gris extremadamente oscuro
        ...
        reseñaArea.setBackground(new Color(5, 5, 5, 255));
        ...
        botonAñadir.setBackground(new Color(5, 5, 5, 255));
        ...
        botonWishlist.setBackground(new Color(5, 5, 5, 255));
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) {
        ...
        panel.setBackground(new Color(5, 5, 5, 255)); // Gris oscuro
