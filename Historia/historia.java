...
public class historia {
    ...
    // Constructor
    public historia(String titulo, String autor, double precio, int cantidadEnStock, String descripcion, String editorial, String fechaPubli, int numP, String idioma, String rutaImagenPortada) {
        this.titulo = titulo;
        this.autor = autor;
        this.precio = precio;
