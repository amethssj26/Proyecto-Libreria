...
public class ventanaLibro {
    ...
    // Constructor
    public ventanaLibro(historia libro) {
        ventana = new JFrame("Detalles del Libro");
        ventana.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ventana.setSize(1540, 1000);

        // Establecer el color de fondo de la ventana
        Color colorFondo = new Color(189, 159, 129, 255); // Azul oscuro
        ...
        tabbedPane.setForeground(new Color(101, 67, 33)); // Gris extremadamente oscuro
        ...
        reseñaArea.setBackground(new Color(229, 198, 169, 255));
        ...
        botonAñadir.setBackground(new Color(101, 67, 33));
        ...
        botonWishlist.setBackground(new Color(101, 67, 33));
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) {
        ...
        panel.setBackground(new Color(101, 67, 33)); // Gris oscuro
