...
public class ventanaCLibro {
    private JFrame ventana;

    // Constructor
    public ventanaCLibro(Cocina libro) {
        ventana = new JFrame("Detalles del Libro");
        ventana.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ventana.setSize(1540, 1000);

        // Establecer el color de fondo de la ventana
        Color colorFondo = (new Color(123, 36, 28)); // Marrón oscuro
        ...
        JLabel reseña1 = new JLabel("Carlos_T: \"Este libro es un verdadero tesoro para los amantes de la cocina ." + //
                        "\n" + //
                        " !");
        ...
        JLabel reseña2 = new JLabel("Marta_G: \"Un libro que transforma la forma de ver la cocina casera. ");
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) {
        ...
        panel.setBackground(new Color(102, 0, 0)); // Azul oscuro
