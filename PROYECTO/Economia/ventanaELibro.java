...
public class ventanaELibro {
    private JFrame ventana;

    // Constructor
    public ventanaELibro(Economia libro) {
        ventana = new JFrame("Detalles del Libro");
        ventana.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ventana.setSize(1540, 1000);

        // Establecer el color de fondo de la ventana
        Color colorFondo = (new Color(121, 85, 72)); // Marrón oscuro
        ...
        JLabel tituloLabel = new JLabel(
                "<html><div style='text-align: left; color: white;'>" + libro.getTitulo() + "</div></html>");
        tituloLabel.setFont(fuenteTitulo);
        informacionPanel.add(tituloLabel);

        informacionPanel.add(Box.createVerticalStrut(10));

        JLabel descripcionLabel = new JLabel("<html><div style='text-align: left; width: 620px; color: white;'>"
                + libro.getDescripcion() + "</div></html>");
        ...
        JLabel reseña1 = new JLabel(
                " Pedro_F: \"Me sorprendió lo bien que toca temas relevantes sobre la productividad" + //
                        "\n" + //
                        " !");
        ...
        JLabel reseña2 = new JLabel(
                "Carlos_M: \"Cada página está llena de ideas que transforman la forma de ver el éxito ");
        ...
        // Añadir el panel de reseñas y el panel de entrada de reseña (área de texto +
        // botón)
        ...
        Image portadaRedimensionada = portadaImage.getImage().getScaledInstance(anchoPortada, altoPortada,
                Image.SCALE_SMOOTH);
        ...
        botonWishlist.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(ventana, "Libro añadido a la wishlist.", "Éxito",
    ...
    private JPanel crearDetalle(String etiqueta, String valor) {
        ...
        panel.setBackground(new Color(78,52,46)); // Azul oscuro
