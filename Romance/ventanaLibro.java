...
public class ventanaLibro {
    ...
    // Constructor
    public ventanaLibro(romance libro) {
        ventana = new JFrame("Detalles del Libro");
        ventana.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ventana.setSize(1540, 1000);

        // Establecer el color de fondo de la ventana
        Color colorFondo = new Color(192, 155, 112, 255); // Azul oscuro
        ...
        tabbedPane.setForeground(new Color(51, 32, 18)); // Gris extremadamente oscuro
        ...
        reseñaArea.setBackground(new Color(192, 155, 112, 255));
        ...
        botonAñadir.setBackground(new Color(51, 32, 18));
        ...
        botonWishlist.setBackground(new Color(51, 32, 18));
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) {
        ...
        panel.setBackground(new Color(51, 32, 18)); // Gris oscuro
