...
public class ventanaLibro {
    ...
    public ventanaLibro(terror libro) {
        ...
        tabbedPane.setForeground(new Color(10, 10, 10)); // Gris extremadamente oscuro
        ...
        reseñaArea.setBackground(new Color(40, 40, 40));
        ...
        botonAñadir.setBackground(new Color(10, 10, 10));
        ...
        botonWishlist.setBackground(new Color(10, 10, 10));
