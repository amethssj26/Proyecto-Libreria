...
public class ventanaLibroCult { 
    ...
    public ventanaLibroCult(cultura libro) { 
        ...
        Color colorFondo = new Color(173, 216, 230); // Azul oscuro 
        ...
        tabbedPane.setForeground(new Color(173, 216, 230)); 
        ...
        reseñaArea.setBackground(new Color(173, 216, 230)); 
        ...
        botonAñadir.setBackground(new Color(173, 216, 230)); 
...
botonWishlist.setBackground(new Color(173, 216, 230)); 
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) { 
        ...
        panel.setBackground(new Color(173, 216, 230)); // Azul oscuro 
