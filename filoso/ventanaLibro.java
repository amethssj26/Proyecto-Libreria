...
public class ventanaLibro {
    ...
    // Constructor
    public ventanaLibro(filosofia libro) {
        ventana = new JFrame("Detalles del Libro");
        ventana.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ventana.setSize(1540, 1000);

        // Establecer el color de fondo de la ventana
        Color colorFondo = (new Color(90, 56, 30)); // Marrón oscuro
        ...
        tabbedPane.setForeground(new Color(90, 56, 30));
        ...
        reseñaArea.setBackground(new Color(60, 37, 20));
        ...
        botonAñadir.setBackground(new Color(60, 37, 20));
        ...
        botonWishlist.setBackground(new Color(60, 37, 20));
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) {
        ...
        panel.setBackground(new Color(90, 56, 30)); // Azul oscuro
