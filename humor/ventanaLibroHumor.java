...
public class ventanaLibroHumor { 
    ...
    public ventanaLibroHumor(humor libro) { 
        ...
        Color colorFondo = new Color(128, 0, 32); // Azul oscuro 
        ...
        tabbedPane.setForeground(new Color(128, 0, 32)); 
        ...
        reseñaArea.setBackground(new Color(128, 0, 32)); 
        ...
        botonAñadir.setBackground(new Color(128, 0, 32)); 
...
botonWishlist.setBackground(new Color(128, 0, 32)); 
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) { 
        ...
        panel.setBackground(new Color(128, 0, 32)); // Azul oscuro 
