...
public class sociedad { 
    ...
    public sociedad(String titulo, String autor, double precio, int cantidadEnStock, String descripcion, String editorial, String fechaPubli, int numP, String idioma, String rutaImagenPortada) { 
