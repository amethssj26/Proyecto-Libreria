...
public class ventanaLibroSoci { 
    ...
    public ventanaLibroSoci(sociedad libro) { 
        ...
        Color colorFondo = new Color(0, 0, 40); // Azul oscuro 
        ...
        tabbedPane.setForeground(new Color(0, 0, 40)); 
        ...
        reseñaArea.setBackground(new Color(40, 40, 60)); 
        ...
        botonAñadir.setBackground(new Color(0, 0, 60)); 
...
botonWishlist.setBackground(new Color(0, 0, 60)); 
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) { 
        ...
        panel.setBackground(new Color(0, 0, 40)); // Azul oscuro 
