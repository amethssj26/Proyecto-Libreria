...
public class ventanaLibroTec { 
    ...
    public ventanaLibroTec(tecnologia libro) { 
        ...
        Color colorFondo = new Color(210, 180, 140); // Azul oscuro 
        ...
        Font fuenteTitulo = new Font("Arial", Font.BOLD, 50); 
        ...
        descripcionLabel.setFont(new Font("Arial", Font.ITALIC, 18)); 
        ...
        cantidadLabel.setFont(new Font("Arial", Font.PLAIN, 30)); 
        ...
        separador.setForeground(Color.WHITE); // Establece el color de la línea 
        ...
        quedanPocosLabel.setFont(new Font("Arial", Font.ITALIC, 28)); 
        ...
        tabbedPane.setForeground(new Color(210, 180, 140)); 

        Font tabFont = new Font("Arial", Font.BOLD, 24); 
        ...
        detallesProductoPanel.add(Box.createVerticalStrut(10)); // Espacio 
        ...
        Font fuenteReseñas = new Font("Arial", Font.ITALIC, 22); // Aumentar el tamaño de la fuente 

 

        // Añadir las reseñas con el color y tamaño de fuente modificados 

        JLabel reseña1 = new JLabel("JuanP_99: ¡Excelente libro, muy interesante!"); 
        ...
        JLabel reseña2 = new JLabel("SofiaLectora: Un poco largo, pero vale la pena."); 
        ...
        reseñaArea.setFont(new Font("Arial", Font.PLAIN, 18)); 

        reseñaArea.setBackground(new Color(210, 180, 140)); 

        reseñaArea.setForeground(Color.WHITE); 
        ...
        botonAñadir.setFont(new Font("Arial", Font.BOLD, 18)); 

        botonAñadir.setBackground(new Color(210, 180, 140)); 

        botonAñadir.setForeground(Color.WHITE); 
...
botonWishlist.setFont(new Font("Arial", Font.BOLD, 18)); 

botonWishlist.setBackground(new Color(210, 180, 140)); 

botonWishlist.setForeground(Color.WHITE); 
...
informacionPanel.add(botonWishlist); 
    ...
    private JPanel crearDetalle(String etiqueta, String valor) { 
        ...
        panel.setBackground(new Color(210, 180, 140)); // Azul oscuro 

 

        JLabel etiquetaLabel = new JLabel("<html><div style='color: white;'>" + etiqueta + "</div></html>"); 

        etiquetaLabel.setFont(new Font("Arial", Font.BOLD, 20)); 
        ...
        valorLabel.setFont(new Font("Arial", Font.PLAIN, 20)); 
